...
MockServer = (function() {
  function MockServer(dataPath, option) {
    var err, md, mockData, socketId, strData, type, wrappedDef;
    if (!dataPath) {
  ...
  MockServer.prototype.addRoute = function(route) {
    var apiPath, dataType, delay, method, ref, ref1, ref2, response, status;
    if (!route) {
      return;
    }
    method = (ref = route['method']) != null ? ref : 'get';
    apiPath = (ref1 = route['path']) != null ? ref1 : '/';
    status = (ref2 = route['status']) != null ? ref2 : 200;
    ...
    return this._app[method](apiPath, function(req, res) {
      ...
      respond = function(result) {
        if (dataType === 'jsonp' && cb) {
          ...
          return res.status(status).end(cb + "&&" + cb + "(" + (JSON.stringify(result)) + ")");
        } else {
